...
The Inventory feature in dIVa provides a comprehensive inventory management system for your Sigils. This feature helps you organize, track, and optimize your sigil collection across different views.
...
![Sigils Stash View](/images/dIVa/sigils-stash.png)
...
![Sigil Dungeon List](/images/dIVa/sigils-list-modal.png)
...
![Sigils Best View](/images/dIVa/sigils-best.png)
...
![Sigils List View](/images/dIVa/sigils-list.png)
...
![Sigils Settings](/images/dIVa/sigils-settings.png)
...
1. Open the Sigils window by clicking the Key icon in the sidebar, and selecting the Stash or Best tab.
2. Use the search bar to find specific sigils or browse the available options.
3. Click on the Analyze icon to select the Tier Type to analyze Sigils for.
4. Use the Season dropdown to view sigils relevant to the current season.
5. To consume a sigil, click the checkmark button. For multiple sigils of the same type, a count will be displayed instead. Clicking this will bring you to a List view for that Sigil type.
6. To add a sigil to your inventory, click the + button.
7. For sigils with affixes, hold down the + button to access the affix management options.
