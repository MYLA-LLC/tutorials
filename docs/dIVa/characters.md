...
- **Favorite:** This auto-selects the alias when a character of the same attributes logs in.
- **Remove:** Delete the Character and all its data.
- **Alias:** User-assigned Alias to help distinguish between characters with the same attributes.
